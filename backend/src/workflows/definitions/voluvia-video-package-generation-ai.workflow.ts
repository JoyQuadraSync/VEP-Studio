...
import { VOLUVIA_VIDEO_PACKAGE_OPERATION_ID, VOLUVIA_VIDEO_PACKAGE_WORKFLOW_ID, VOLUVIA_VIDEO_PACKAGE_WORKFLOW_VERSION } from '../examples/voluvia/video-package/voluvia-video-package-contracts';
